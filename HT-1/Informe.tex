      ...
      \item \textbf{Métrica A (Flujo vehicular):} Podemos empezar con dos opciones bastante \textit{naive}, tales como:
        ...
        \item \textbf{Ocupación de carril:} En lugar de contar la cantidad de autos cruzando, buscamos medir que porcentaje
          ...
          \vspace{1em}
            ...
            en una zona de alto tráfico ya que los deadlocks son inevitables. Adicionalmente, podemos explorar algunas
            otras métricas auxiliares para tener una función de costo más robusta. Tomando también en cuenta las limitaciones
            de esta métrica bajo tráfico extremadamente pesado.
