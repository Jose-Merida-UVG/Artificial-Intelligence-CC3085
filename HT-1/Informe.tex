...
\begin{enumerate}
  ...
  \item \textit{Basándose en la diapositiva de Incertidumbre, explique por qué este entorno de tráfico nunca podría
    ...
    Por último, este entorno jamás puede ser \textit{Completamente Observable} aún descartando las limitantes de sensores. En un
    caso hipotético dónde tengamos cada milímetro cubierto con un mapeo 3D en tiempo real, ¿que sucede al momento que dos carros
    colisionan?

    Aquí tenemos un ambiente adverso, dónde el sistema jamás puede conocer con certeza el estado siguiente del ambiente. Aquí
    podemos generar aún más preguntas, aunque el sistema logre reconocer un choque jamás podrá saber si:

  \begin{itemize}
    \item Un conductor se bajará e iniciará un altercado físico con el otro
    \item Los conductores en todos los carriles adyacentes se bajarán a ayudar (o tomar fotos)
    \item Una ambulancia venía justo atrás de ellos y se han parado a ayudar, o en otro caso la misma ambulancia decide no
      tomar acción alguna
  \end{itemize}
